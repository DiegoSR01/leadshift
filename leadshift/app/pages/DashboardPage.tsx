...
export function DashboardPage() {
  ...
  const progressData = dashboard?.weeklyProgress || [];
  const recentActivity = dashboard?.recentActivity || [];
  const moduleProgress = dashboard?.moduleProgress || [];
  const kpis = dashboard?.kpis || { streak: 0, xp: 0, modulesCompleted: '0/0', avgScore: 0 };
      ...
      <div className="px-8 py-6 space-y-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            { icon: BookOpen, label: 'Módulos', value: kpis.modulesCompleted, sub: 'Completados', color: 'text-violet-500 bg-violet-50' },
                  ...
                  <div key={i} className="flex items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-sm font-bold text-slate-700 ml-2">{mod.progress || 0}%</span>
                      </div>
          ...
          <div className="bg-white rounded-2xl p-6 border border-slate-100 shadow-sm">
            ...
            <div className="space-y-4">
              {recentActivity.length === 0 ? (
                ...
                const actInfo = activityIcons[act.type] || activityIcons.leadership;
